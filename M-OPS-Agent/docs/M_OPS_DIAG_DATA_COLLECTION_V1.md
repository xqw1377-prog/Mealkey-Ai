...
**诊断模型详细设计已补充：** `docs/M_OPS_DIAG_DIAGNOSIS_MODEL_V1_1_DETAIL.md`  

**下一刀：** `docs/M_OPS_DIAG_DATA_INTELLIGENCE_V1_1.md`  
先冻结 Restaurant Reality Model、Customer Voice Intelligence、Restaurant World、Daily Health Scan 与证据可信度规则，再推进引擎竖切与 UX 五页。
...
| V1.1 Data Intelligence Link | 2026-07-21 | 补充指向数据采集与外部情报引擎设计真源，收口 Restaurant World 与 Customer Voice Intelligence |
