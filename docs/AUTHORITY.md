...
> 生效日：2026-07-17（Council System 收口：2026-07-18；User Intelligence Evolution：2026-07-18；Restaurant Brain：2026-07-18；Decision Center：2026-07-18；Decision Intelligence Engine：2026-07-18；M-INTEL：2026-07-18；Decision Context：2026-07-18；**Decision Experience：2026-07-18**；**Experience Blueprint P0–P5 工程收口：2026-07-19**；**Restaurant Intelligence Profile：2026-07-19**）  
...
| **L0 入口交互（旧）** | `docs/MEALKEY_DECISION_CENTER_INTERACTION_V1.md` | 会议室/Feed/Journey 细节参考 | **否** — **与 Experience 冲突时以 Experience 为准** |
...
13j. **DIE 技术架构映射 V1 已冻结**（2026-07-18）：落点 outcome+Brain；接线 Council/四席/M-EXEC；Cursor 文件清单 T0–T5。真源：`MEALKEY_DECISION_INTELLIGENCE_TECH_MAP_V1.md`。  
18. **Experience Blueprint P0–P5 工程已收口（2026-07-19）**：契约 · Candidate/Inbox · Challenge/Readiness · 经营决策习惯 · M-INTEL 锚点门禁均已接线；真源 `MEALKEY_DECISION_EXPERIENCE_ENGINEERING_BLUEPRINT_V1.md`。黄金路径手测仍有效；**并行主线 = Restaurant Intelligence Profile（第一价值瞬间）**。禁止 Scan 滥造 Decision、无锚点装懂外部、对外「决策人格」字样。  
