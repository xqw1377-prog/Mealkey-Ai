...
export const caseAssets: CaseAsset[] = [
  ...
  },
  {
    ...
    market_stage: "成长期",
    project_stage: "品类占位",
    initial_problem: "保暖内衣品类消费者不知选谁，功能同质化",
    resource_condition: "有电视广告投放能力",
    competition_context: "竞品讲舒适/科技/低价，品类名未被占据",
    candidate_positions: ["最暖的内衣", "科技保暖", "保暖就是北极绒"],
    final_position: "保暖就是北极绒——品类名=功能名=品牌名",
    why_choose: "把品牌名与品类核心功能合一，简单可重复",
    why_not_others: "最暖无标准，科技消费者难感知",
    differentiation_design: "代言人+同一句话重复，北极绒=保暖",
    execution_actions: ["电视重复投放", "终端统一话术", "品牌名即功能承诺"],
    market_feedback: "消费者选保暖内衣时北极绒成为默认选项之一",
    result_summary: "品类占位式冲突：一句话把品牌名变成功能代名词",
    success_or_failure: "success",
    quality_tier: "silver_case",
    mental_takeaway: "品牌名与品类功能合一是最简冲突表达",
    reusable_principles: ["用常识判断", "重复是记忆的母亲", "不同比更好更重要"],
    risk_lessons: ["延伸至非保暖品类稀释占位", "季节性强需副品牌策略"],
    theory_tags: ["ye_maozhong", "ries"],
  },
  {
    id: "case-ambrosial",
